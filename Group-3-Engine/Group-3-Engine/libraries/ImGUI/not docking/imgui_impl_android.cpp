...
int32_t ImGui_ImplAndroid_HandleInputEvent(const AInputEvent* input_event)
{
    ...
    case AINPUT_EVENT_TYPE_MOTION:
    {
        ...
        //__android_log_print(ANDROID_LOG_VERBOSE, "tag", "%s", std::to_string(event_action).c_str());
        //__android_log_print(ANDROID_LOG_VERBOSE, "tag", "%s", std::to_string(event_pointer_index).c_str());
        switch (event_action)
        {
        case AMOTION_EVENT_ACTION_DOWN:
            //__android_log_print(ANDROID_LOG_VERBOSE, "tag", "down");
            io.AddMousePosEvent(AMotionEvent_getX(input_event, event_pointer_index), AMotionEvent_getY(input_event, event_pointer_index));
            io.AddMouseButtonEvent(0, true);
        case AMOTION_EVENT_ACTION_UP:
        {
            //__android_log_print(ANDROID_LOG_VERBOSE, "tag", "up");
        ...
        case AMOTION_EVENT_ACTION_MOVE:       // Touch pointer moves while DOWN
            io.AddMousePosEvent(AMotionEvent_getX(input_event, event_pointer_index), AMotionEvent_getY(input_event, event_pointer_index));
            io.AddMouseButtonEvent(0, true); //still count as holding
            break;
